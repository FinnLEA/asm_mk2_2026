...
prompt1 db 201, 205, 205, 205, ' -----------------AMAXACLA----------------- ', 205, 205, 205, 187, 0
prompt2 db '[ENTER] - SOGLASEN', 179, '  [ESC] - Otmena', 0
header_text db 219, 219, ' ---------------------AMAXACLA LOGGER--------------- ', 219, 219, 0
footer_text db 177, ' F1-F10:Keys ', 177, ' Arrows ', 177, ' Ctrl+L:Clear ', 177, ' Ctrl+S:Flush ', 177, ' ESC:Quit ', 177, 0
...
_draw_main_window proc near
    ...
    ; Разделитель заголовка (бирюзовый)
...
draw_footer_sep:
    ...
    push 0C4h
    push bx
    push WINDOW_Y + WINDOW_HEIGHT - 2
    call _write_char_at
    add sp, 8
    inc bx
    pop cx
    loop draw_footer_sep
