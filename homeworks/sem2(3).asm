...
atoi_err:
    mov atoi_error, 1       ; ← код 1: неверный символ
    xor ax, ax
    jmp atoi_ret

atoi_range_err:
    mov atoi_error, 2       ; ← код 2: выход за диапазон
    xor ax, ax
    jmp atoi_ret
...
ask_expr:
    ...
    call _atoi
    add sp, 2
    cmp atoi_error, 1       ; ← неверный символ → Invalid format
    je  err_format
    cmp atoi_error, 2       ; ← вне диапазона → Out of range
    je  err_out_range
    mov num_a, ax
