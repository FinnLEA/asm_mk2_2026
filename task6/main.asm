...
data segment para public use16
    ...
    char_to_write   db 0          ; буфер для одного символа при записи в файл
...
; ============================================
; Горизонтальная линия рамки
; Параметры в стеке (сверху вниз):
;   flag (1=верх,0=низ), width, left
;   row передаётся в bx
; ============================================
...
; ============================================
; Вертикальная линия
; Параметры: row, left, width, attr (4 шт.)
; ============================================
...
; Параметры: top, left, height, width, attr
; ============================================
...
; ============================================
; Вывод символа в лог (экран + файл) – ИСПРАВЛЕННАЯ
; ============================================
...
; ============================================
; Получение строки для спецклавиш (по скан-коду)
; ============================================
...
; ============================================
; Сброс файла лога (закрыть и пересоздать)
; ============================================
...
; ============================================
; Перевод строки в логе (только для Enter)
; ============================================
...
file_ok:
    ...
    push 1Fh
    push 'A'
    call print_char_to_log   ; после этого должна появиться жёлтая '*', и 'A' в логе
